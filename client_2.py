# client_2.py  (sadece: python client_2.py)
...
def train_local_rf(X, y, n_estimators=300, random_state=22, max_depth=None):
...
def main():
    ...
    clf = train_local_rf(Xtr, ytr, n_estimators=300, random_state=22)
